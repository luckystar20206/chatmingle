    ...
    <div x-data="LivewireUIModal()" x-on:close.stop="setShowPropertyTo(false)"
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-10 text-center">
            ...
            <div x-show="show && showActiveComponent" x-transition:enter="ease-out duration-300"
                ...
                class="inline-block w-full align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:w-1/2"
